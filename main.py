...
def main():
    ...
    st.markdown('[Author email](mailto:markboni55@gmail.com)')
    ...
    st.sidebar.markdown('# Made by: [Mark](https://github.com/markboni55)')
    st.sidebar.markdown('# Git link: [Docsummarizer](https://github.com/markboni55/GPT-Doc-Summarizer)')
